...
})({"9gSPV":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "9eb14c68036eadbc";
"use strict";
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (clearWatchlistButton) clearWatchlistButton.addEventListener("click", ()=>{
        const watchlistRef = (0, _database.ref)(db, "watchlist");
        (0, _database.remove)(watchlistRef).then(()=>{
            location.reload();
        });
    });
    ...
    function loadWatchlist() {
        ...
        const watchlistRef = (0, _database.ref)(db, "watchlist");
        (0, _database.get)(watchlistRef).then((snapshot)=>{
            if (snapshot.exists()) {
